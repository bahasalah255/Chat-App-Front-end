    ...
    <div className="flex items-center justify-center min-h-screen px-4 py-4 bg-[#f8f7f4] font-sans text-[#1a1a2e] antialiased">
      <div className="w-full max-w-[380px] bg-white border border-[#e2e0da] rounded-xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.06)] z-10">
        ...
        <div className="px-6 py-6 flex flex-col items-center">
          ...
          <h1 className="text-lg font-semibold mb-0.5 text-center">Welcome back</h1>
          <p className="text-[12px] text-[#8888aa] mb-5 text-center">Sign in to your account to continue</p>
          ...
          <form className="w-full flex flex-col" onSubmit={handleLogin}>
            ...
            <div className="w-full flex justify-end mb-4 -mt-1">
              <a href="#forgot" className="text-[11px] text-[#4F6EF7] font-medium hover:underline">
                Forgot password?
              </a>
            </div>
            ...
            <p className="text-[12px] text-[#8888aa] text-center">
              ...
              <Link to="/register" className="text-[#4F6EF7] font-medium hover:underline">Create one</Link>
            </p>
          </form>
        </div>
      </div>
